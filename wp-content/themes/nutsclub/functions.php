...
.trn-table-wrap{overflow-x:auto;border:1px solid rgba(255,255,255,.06);border-radius:12px;background:#181818}
.trn-table{width:100%;border-collapse:collapse}
.trn-table thead{background:#202020}
.trn-table th{text-align:left;padding:12px 14px;font-size:12px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;color:#808080;border-bottom:1px solid rgba(255,255,255,.06);white-space:nowrap}
.trn-table td{padding:10px 14px;font-size:13px;color:#BFBFBF;border-bottom:1px solid rgba(255,255,255,.03)}
